...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-10-2025 a las 22:54:14
...
--
-- Truncar tablas antes de insertar `customers`
--
...
--
-- Truncar tablas antes de insertar `employees`
--
...
--
-- Truncar tablas antes de insertar `offices`
--
...
--
-- Truncar tablas antes de insertar `orderdetails`
--
...
--
-- Truncar tablas antes de insertar `productlines`
--
